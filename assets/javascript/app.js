...
$(document).ready(function () {
    ...
    var question3 = new question("who is awesome?", "anyone who is not Jar Jar Binks", "you", "Jar Jar Binks", "me");
    questions.push(question3);
    var question4 = new question("What is a parsec?", "a unit of distance equal to 3.26 light-years.", "a type of fruit", "the distance light travels in a second", "what Jar Jar Binks tries to sell to unsuspecting children");
    ...
    var question6 = new question("Which of the following problems have remained unsolved in modern physics?", "The Three body problem", "Kepler's fourth law", "Jar Jar Binks", "Okham's dilemma");
    questions.push(question6);
    var question7 = new question("is light a particle, or a wave?", "light can be both particle and wave.", "particle only", "wave, only", "neither particle, nor wave, but Jar Jar Binks");
